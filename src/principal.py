...
def process_sample(kmer_length, sample_key=None, c_fastq_file=None, n_fastq_file=None, min_support_percentage=2, n_permutations=1000, destination_directory=".", export_gml=False):
